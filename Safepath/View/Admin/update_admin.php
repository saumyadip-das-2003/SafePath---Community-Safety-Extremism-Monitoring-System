...
<?php include('../../Model/Admin/update_admin.php'); ?>
...
<head>
    ...
    <title>Update Admin - SafePath</title>
...
<body>
    ...
    <div class="content">
        ...
        <?php if (isset($status)): ?>
            <div class="status-message">
                <?php if ($status == 'success'): ?>
                    <p style="color: green;">Admin updated successfully!</p>
                <?php elseif ($status == 'error'): ?>
                    <p style="color: red;">Error updating admin. Please try again.</p>
                <?php endif; ?>
            </div>
        <?php endif; ?>

        <!-- Search Form -->
        <form method="GET" action="update_admin.php" class="search-form">
            <input type="text" name="search" placeholder="Search by email..." value="<?php echo htmlspecialchars($search); ?>" required>
            <button type="submit">Search</button>
        </form>

        <!-- Display error message if no admin is found -->
        ...
        <!-- Admin Update Form -->
        <?php if (isset($admin)): ?>
            <form method="POST" action="update_admin.php" class="update-admin-form">
                <input type="hidden" name="update_admin_id" value="<?php echo $admin['id']; ?>">
